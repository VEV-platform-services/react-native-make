 ...
 */
function getAndroidResourceOutputPath() {
    return (OUTPUT_PATH || config_1.ANDROID_MAIN_PATH) + '/res';
}
exports.getAndroidResourceOutputPath = getAndroidResourceOutputPath;
